...
//远程服务器所在的url
var manifest = {
    packageUrl: 'http://update.gametest.com/hotupdate/',
    remoteManifestUrl: 'http://update.gametest.com/hotupdate/project.manifest',
    remoteVersionUrl: 'http://update.gametest.com/hotupdate/version.manifest',
    version: '1.0.0',
    assets: {},
    searchPaths: []
};
